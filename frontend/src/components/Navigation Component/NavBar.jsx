...
class NavBar extends React.Component {
  ...
  renderUserName = () => {
    if (this.state.user === null) {
      ...
      return <span><b>Hi {this.state.user.userName}</b></span>;
    }
  };
      ...
      <div>
        ...
        >
          <Link className="nav-link" to="/">
            <i>
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiYnlLkReDuPRfhMQHgXoqoNORlZHc7KIUhw&usqp=CAU"
                alt="pc"
                width="50px"
              />
            </i>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto" style={{ marginLeft: "1.5rem"}}>
              ...
              <li className="nav-item">
                {this.state.user && this.state.user.role === "ADMIN" && (
                  <Link className="nav-link" to="/admin">
                    <i className="fa fa-file" aria-hidden="true" /> <b>AdminPage</b>
                  </Link>
                )}
              </li>
              ...
              <li className="nav-item">
                {
                  <Link className="nav-link" to="/contactus">
                    <i className="fa fa-phone" aria-hidden="true" /> <b>ContactUs</b>
                  </Link>
                }
              </li>
              ...
              <li className="nav-item">
                {!this.state.user && (
                  <Link className="nav-link" to="/login" style={{ marginLeft: "50rem" }}>
                    <i className="fa fa-sign-in" aria-hidden="true" /> <b>Login</b>
                  </Link>
                )}
              </li>
            </ul>
